#ifndef ENERGYLEAF_SENSOR_CAMERAEL_HPP
#define ENERGYLEAF_SENSOR_CAMERAEL_HPP
    ...
    Apalinea::Core::Type::Image getInternalImage() const override {
        ...
        if (!framebuffer) {
            ...
            if (!validJpeg) {
                ...
                if (!framebuffer) {
                    throw std::runtime_error("Camera capture failed in second try!");
                }
            }
        }
...
#endif //ENERGYLEAF_SENSOR_CAMERAEL_HPP